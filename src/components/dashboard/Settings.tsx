      ...
      <div className="bg-white p-6 rounded-lg shadow-sm">
        <div className="space-y-4 max-w-lg">
          <div>
            ...
            <input id="shopName" type="text" value={shopName} onChange={e => setShopName(e.target.value)} className="form-input mt-1" />
          </div>
          <div>
            <label htmlFor="gstNumber" className="font-medium text-gray-700">GST Number</label>
            <input id="gstNumber" type="text" value={gstNumber} onChange={e => setGstNumber(e.target.value)} className="form-input mt-1" />
          </div>
          <div>
            <label htmlFor="billMessage" className="font-medium text-gray-700">Custom Bill Message</label>
            <input id="billMessage" type="text" value={billMessage} onChange={e => setBillMessage(e.target.value)} className="form-input mt-1" />
          </div>
          <div className="pt-2">
